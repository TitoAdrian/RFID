    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            catch (IOException e)
            {
                ...
                // This may help with some connection issues
                // Code derived from:
                // http://stackoverflow.com/questions/18657427/ioexception-read-failed-socket-might-closed-bluetooth-on-android-4-3?rq=1
                ...
                {
                    // All attempts have failed - close the socket
                    try
                    {
                        synchronized (this)
                        {
